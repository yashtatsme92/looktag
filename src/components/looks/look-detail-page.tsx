...
import { MoreLikeThisButton } from "@/components/looks/more-like-this-button";
...
import { isEditorialLook, ownsLook, type Look } from "@/lib/looks/types";

type LookDetailPageProps = {
  lookId: string;
  ssrLook: Look | null | undefined;
};

export function LookDetailPage({ lookId, ssrLook }: LookDetailPageProps) {
